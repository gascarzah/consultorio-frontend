    ...
    <>
      <tr>
        ...
        <td className="px-6 py-4 text-sm text-gray-800 whitespace-nowrap">
          {programacionDetalle?.empleado?.persona.apellidoPaterno +
            " " +
            programacionDetalle?.empleado?.persona.apellidoMaterno +
            " " +
        ...
        {/* <td className="px-6 py-4 text-sm text-gray-800 whitespace-nowrap">
          {programacionDetalle.estado === 0 ? "ACTIVO" : "DESACTIVO"}
        </td> */}
        <td className="px-6 py-4 text-sm text-gray-800 whitespace-nowrap flex gap-2">
          <Link
            to={`editar-programacion-detalle/${programacionDetalle?.programacion.idProgramacion}`}
          >
            <svg
          ...
          <Link
            to={`/listar-programacion-detalle/editar-programacion-detalle/${programacionDetalle?.programacion.idProgramacion}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
